...
//  Movie Collection
//
//  Created by BarisSaglam on 20.07.2019.
...
extension UIColor{
    static var themePrimaryColor: UIColor{
    ...
    static var themeTintColor: UIColor{
        return UIColor.init(red: 183/255, green: 28/255, blue: 28/255, alpha: 1.0)
    }
}
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = UIColor.themePrimaryColor
        
        
        // MARK: - UITabBar configure
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Movie_Collection")
